      ...
      <button onClick={handleClick} className={buttonStyles}>
        <div className={styles.Description__imageContainer}>
          <Image
            ...
            fill //// Hace que la imagen llene completamente el contenedor padre, debe tener position: relative, width y height
            placeholder="blur" ////Muestra una versión borrosa de la imagen mientras se carga la imagen original, mejorando una mejor experinecia del usuario.
